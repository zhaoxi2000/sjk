...
public class ChangeOutputImpl {
    ...
    public void setUrls(App app) {
        // String downloadUrl = String.format(appConfig.getDownLoadBaseUrl(),
        // (app.getId() / 500), app.getDownLoadLink());
        // app.setDownloadUrl(downloadUrl);
        // if (!StringUtils.isEmpty(app.getLogo())) {
        // StringBuilder logoUrl = new
        // StringBuilder(appConfig.getAppLogoBaseUrl().length() +
        // app.getLogo().length());
        // logoUrl.append(appConfig.getAppLogoBaseUrl()).append(app.getLogo());
        // app.setLogoUrl(logoUrl.toString());
        // }
        // app.setPageUrl(appConfig.getAppPageBaseUrl() + "/" + (app.getId() /
        // 500) + "/" + app.getId() + ".html");
        //
        // if (!StringUtils.isEmpty(app.getOneKeyPack())) {
        // app.setOneKeyPackUrl(appConfig.getDownLoadOneKeyPackBaseUrl() +
        // app.getOneKeyPack());
        // }
    ...
    // String imageUrl = appConfig.getAppImageBaseUrl() +
    // appScreenImage.getImageUrl();
    // appScreenImage.setImageUrl(imageUrl);
    // }

    // public void setAppExtendDataUrl(ExtendData ext) {
    // String downloadUrl = appConfig.getDownLoadDataBaseUrl() +
    // ext.getDownloadLink();
    // ext.setDownloadUrl(downloadUrl);
    // if (ext.getScreenshot() != null) {
    // StringBuilder imageUrl = new
    // StringBuilder(appConfig.getAppDataImageBaseUrl().length()
