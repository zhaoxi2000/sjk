 ...
 * </pre>
 */
public class AppForBigGamePacksVo implements java.io.Serializable {
    ...
    private AppForBigGamePacksVo(Integer id, String version, int marketAppId, String marketName, String name,
            ...
            Integer bigGamePackId, byte cputype, String url, int size, long freeSize, Date marketUpdateTime,
            String unsupportPhoneType) {
        super();
        this.id = id;
