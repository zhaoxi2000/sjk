 ...
 * 提供给pc端大游戏安装包使用(查询多次封装后的实体)
 * </pre>
 */
public class AppForAllBigGameVo implements java.io.Serializable {
    ...
    private Set<BigGamePack> apkPackList = new HashSet<BigGamePack>();

    public AppForAllBigGameVo() {
        super();
    }

    private AppForAllBigGameVo(Integer id, String version, int marketAppId, String marketName, String name,
            ...
            String virusBehaviors, String virusName, String md5, int appId, int apkId, String logo1url, int scSta,
            Set<BigGamePack> apkPackList) {
        super();
        this.id = id;
    ...
    public Set<BigGamePack> getApkPackList() {
        return apkPackList;
    }

    public void setApkPackList(Set<BigGamePack> apkPackList) {
        this.apkPackList = apkPackList;
    }
