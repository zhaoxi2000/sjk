...
public interface SearchService1 {
     ...
     * @throws Exception
     */
    Pager<SearchApp> search(String q, int page, int rows, Integer noAds, Integer official) throws Exception;
     ...
     * @throws Exception
     */
    Pager<SearchApp> searchInTotalhitsByQuery(TopDocs topDocs, int page, int rows) throws Exception;
