...
// Generated 2013-1-4 14:42:00 by Hibernate Tools 3.4.0.CR1
...
@Table(name = "App", catalog = "AndroidMarket", uniqueConstraints = @UniqueConstraint(columnNames = { "Pkname",
        "SignatureSHA1" }))
public class App extends ComparableBaseApp implements java.io.Serializable {
    ...
    public App(String marketName, String pkname) {
        super();
        this.marketName = marketName;
        this.pkname = pkname;
    }

    public App(int marketAppId, String marketName, String name, short catalog, int subCatalog, int size, long freeSize,
            String downloadUrl, String logoUrl, String description, String publisherShortName, long versionCode,
            String osversion, String pkname, float price, String keywords, float starRating, int viewCount,
            int downloads, int downloadRank, short supportpad, String enumStatus, boolean auditCatalog, boolean hidden,
            String indexImgUrl, String language, boolean audit, byte pathStatus, byte adRisk, int realDownload,
            int deltaDownload, int lastDayDownload, int lastDayDelta, int lastWeekDownload, int lastWeekDelta,
            byte virusKind, int appId, int apkId) {
    ...
    public App(int marketAppId, String marketName, String name, String engName, short catalog, int subCatalog,
            ...
            String keywords, float starRating, int viewCount, int downloads, int downloadRank, short supportpad,
            ...
            Integer status, boolean autoCover) {
        this.marketAppId = marketAppId;
        this.marketName = marketName;
        this.name = name;
    ...
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "ApkScanTime", length = 19)
