...
public class App extends ComparableBaseApp implements java.io.Serializable {
    ...
    public App(int marketAppId, String marketName, String name, short catalog, int subCatalog, int size, long freeSize,
            ...
            String osversion, String pkname, Date lastUpdateTime, Date lastFetchTime, float price, String keywords,
            float starRating, int viewCount, int downloadRank, short supportpad, String enumStatus,
            ...
            int lastWeekDownload, int lastWeekDelta, byte virusKind, int appId, int apkId, int status,
            boolean autoCover, int scSta) {
