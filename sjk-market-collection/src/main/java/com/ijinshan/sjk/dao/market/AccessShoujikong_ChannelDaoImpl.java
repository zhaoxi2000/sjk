 ...
 */
@Repository
public class AccessShoujikong_ChannelDaoImpl extends AccessYingyongsoDaoImpl {
    private static final Logger logger = LoggerFactory.getLogger(AccessShoujikong_ChannelDaoImpl.class);
    ...
    public String getFullUrl(Market market) {
        ...
        // http://www.yingyong.so/shoujikong/ijinshan_shoujikong_on_{day}.csv.gz
        ...
        url.append("ijinshan_shoujikong_all_");
        url.append(date);
        url.append(".csv.gz");
        url.append("?t=");
