    ...
    $('#softList').datagrid({
        ...
        columns : [[{
            ...
            formatter : function(value, rec, index) {
                ...
                var ids = '<img class="w_20 h_20 f_l mt_4 mr_10" src="' + rec.logoUrl + '"/>' + '<a name="softIds" class="co_bl f_l" value="' + rec.id + '" href="' + url + '"  target="_blank">' + value + '</a>';
                return ids;
            }
        }, {
            field : 'version',
            ...
            width : 180,
            formatter : function(value, rec, index) {
                var edit = '<a name="softIds" class="co_bl f_l mr_15" value="' + rec.id + '" href="../admin/app/' + rec.id + '.d?id=' + rec.id + '"  target="_blank">编辑</a>';
...
var catalogMap = [], tagsMap = [], topicsMap = [], moTopicsMap = [], moTagMap = [], moStausMap = [];
